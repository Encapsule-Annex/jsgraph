...
module.exports = function (digraphIn_) {
    ...
    for (var vertexId in digraphIn_.vertexMap) {
        var vertexProperties = JSON.parse(JSON.stringify(digraphIn_.vertexPropertyObject(vertexId)));
    ...
    for (index in outEdges) {
        ...
        var edgeProperties = JSON.parse(JSON.stringify(digraphIn_.edgePropertyObject(edge.u, edge.v)));
